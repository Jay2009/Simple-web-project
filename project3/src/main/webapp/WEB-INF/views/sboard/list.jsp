...
<img src="/resources/Portfolio.png" style="width:128px;height:100px;">
		...
		<div class="col-md-12">
			...
			<div class='box'>
				...
				<div class='box-body'>
					...
					<button id='newBtn'>Register portfolio</button>
</span>
				</div>
			</div>
						...
						<c:forEach items="${list}" var="boardVO">
							...
							<tr>
								...
								<td><a
									...
									<c:if test="${id == boardVO.writer}"><strong style="color:green"></c:if>	${boardVO.title} <strong>[ ${boardVO.replycnt} ] </strong></a></td>
								<td> <c:if test="${id == boardVO.writer}"><strong style="color:green"></c:if>  ${boardVO.writer}</td>
