...
public class SearchBoardController {
  ...
  public void read(@RequestParam("bno") int bno, @ModelAttribute("cri") SearchCriteria cri, Model model, HttpSession session)
      throws Exception {
  ...
  public String registPOST(BoardVO board, RedirectAttributes rttr) throws Exception {
    ...
    System.out.println("sboard register::"+board);
